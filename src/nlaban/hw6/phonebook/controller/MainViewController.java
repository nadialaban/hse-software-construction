...
public class MainViewController {
    ...
    public TableColumn<Contact, Long> id;
    ...
    public void deleteSelectedContact(ActionEvent actionEvent) {
        var selected = table.getSelectionModel().getSelectedItem();
        if (selected != null) {
            PhoneBook.removeContact(selected.getId());
            showContacts();
        }
    }
    ...
    public void importContacts(ActionEvent actionEvent) {
        ...
        try {
            FXMLLoader root = new FXMLLoader(ImportViewController.class.getResource("/view/importView.fxml"));
            Parent rootPane = root.load();
    ...
    public void exportContact(ActionEvent actionEvent) {
        ...
        try {
            FXMLLoader root = new FXMLLoader(ExportViewController.class.getResource("/view/exportView.fxml"));
            VBox rootBox = root.load();
            exportStage.setResizable(false);
            exportStage.setScene(new Scene(rootBox));
    ...
    public void about(ActionEvent actionEvent) {
        ...
        try {
            FXMLLoader root = new FXMLLoader(ExportViewController.class.getResource("/view/aboutView.fxml"));
            AnchorPane rootPane = root.load();

            aboutStage.setScene(new Scene(rootPane));
