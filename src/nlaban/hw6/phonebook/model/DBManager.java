...
public class DBManager {
    static final String DERBY_CREATE_URL = "jdbc:derby:phonebook-db;create=true";
    static final String DERBY_URL = "jdbc:derby:phonebook-db;create=true";
    ...
    public static void createDB() {
        try (Connection connection = DriverManager.getConnection(DERBY_CREATE_URL);
    ...
    private static void setStatementValues(Contact contact, PreparedStatement statement) throws SQLException {
        ...
        var date = contact.getBD() == null ? null : Date.valueOf(contact.getBD().toString());
